...
public static partial class GuardExtension
{
    ...
    public static DateTime Default(this IGuardClause _, DateTime input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not default for that type.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static DateTime Default(this IGuardClause _, DateTime input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not default for that type.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static DateTime Default(this IGuardClause _, DateTime input, string paramName, string message)
    {
