...
public static partial class GuardExtension
{
    ...
    public static double NegativeOrZero(this IGuardClause _, double input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative or zero.</returns>
    public static double NegativeOrZero(this IGuardClause _, double input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative or zero.</returns>
    public static double NegativeOrZero(this IGuardClause _, double input, string paramName, string message)
    {
