...
public static partial class GuardExtension
{
    ...
    public static double Negative(this IGuardClause _, double input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static double Negative(this IGuardClause _, double input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static double Negative(this IGuardClause _, double input, string paramName, string message)
    {
