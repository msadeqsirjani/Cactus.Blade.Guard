...
public static partial class GuardExtension
{
    ...
    public static int Zero(this IGuardClause _, int input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not zero.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static int Zero(this IGuardClause _, int input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not zero.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static int Zero(this IGuardClause _, int input, string paramName, string message)
    {
