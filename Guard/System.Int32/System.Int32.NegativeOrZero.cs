...
public static partial class GuardExtension
{
    ...
    public static int NegativeOrZero(this IGuardClause _, int input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative or zero.</returns>
    public static int NegativeOrZero(this IGuardClause _, int input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative or zero.</returns>
    public static int NegativeOrZero(this IGuardClause _, int input, string paramName, string message)
    {
