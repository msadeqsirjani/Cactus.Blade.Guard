...
public static partial class GuardExtension
{
    ...
    public static long? Default(this IGuardClause _, long? input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not default for that type.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static long? Default(this IGuardClause _, long? input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not default for that type.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static long? Default(this IGuardClause _, long? input, string paramName, string message)
    {
