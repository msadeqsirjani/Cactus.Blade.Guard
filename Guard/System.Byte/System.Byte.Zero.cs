...
public static partial class GuardExtension
{
    ...
    public static byte Zero(this IGuardClause _, byte input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not zero.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static byte Zero(this IGuardClause _, byte input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not zero.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static byte Zero(this IGuardClause _, byte input, string paramName, string message)
    {
