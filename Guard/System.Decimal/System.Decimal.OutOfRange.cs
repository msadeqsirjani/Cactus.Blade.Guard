...
public static partial class GuardExtension
{
    ...
    {
        return Guard.MustBe.OutOfRange<decimal>(input, rangeFrom, rangeTo);
    }
    ...
    {
        return Guard.MustBe.OutOfRange<decimal>(input, paramName, rangeFrom, rangeTo);
    }
    ...
    {
        return Guard.MustBe.OutOfRange<decimal>(input, paramName, message, rangeFrom, rangeTo);
    }
