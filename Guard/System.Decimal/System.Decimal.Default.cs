...
public static partial class GuardExtension
{
    ...
    public static decimal Default(this IGuardClause _, decimal input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not default for that type.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static decimal Default(this IGuardClause _, decimal input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not default for that type.</returns>
    /// <exception cref="ArgumentException"></exception>
    public static decimal Default(this IGuardClause _, decimal input, string paramName, string message)
    {
