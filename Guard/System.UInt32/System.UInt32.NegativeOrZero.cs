...
public static partial class GuardExtension
{
    ...
    public static uint NegativeOrZero(this IGuardClause _, uint input)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative or zero.</returns>
    public static uint NegativeOrZero(this IGuardClause _, uint input, string paramName)
    {
    ...
    /// <returns><paramref name="input" /> if the value is not negative or zero.</returns>
    public static uint NegativeOrZero(this IGuardClause _, uint input, string paramName, string message)
    {
